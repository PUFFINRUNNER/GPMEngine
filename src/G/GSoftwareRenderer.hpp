...
namespace G {
    ...
    class SoftwareRenderer3D final : public IRenderer3D {
    public:
        SoftwareRenderer3D() = default;
        ~SoftwareRenderer3D() override;
    ...
    private:
        ...
        ALLEGRO_BITMAP* m_outputBitmap = nullptr;
        ...
        void putPixel(int x, int y, float depth, const Color& color) noexcept;
        void rasterizeLine(const ScreenPoint3D& a,
                   const ScreenPoint3D& b,
