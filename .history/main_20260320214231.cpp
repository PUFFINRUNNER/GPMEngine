...
namespace {
    ...
    public:
        ...
        void onInit() override {
            ...
            m_model = G::ObjLoader::load("assets/Cardboard box.obj");
std::cout << "model parts: " << m_model.parts.size() << std::endl;
        ...
        void onRender(const G::Viewport& viewport, double /*alpha*/) override {
            ...
            if (snapshot.model.valid) {
                ...
                M::Transform3D t;
                t.position = M::Point3D(0.0f, 0.0f, -4.0f);
                t.rotation = M::Quaternion::identity();
                t.scale = M::Vector3D(0.05f, 0.05f, 0.05f);
    ...
    private:
        ...
        void physicsLoop() {
            ...
            setupPhysicsWorld(world, baseBody, dropBody);
            ...
            while (m_physicsRunning) {
                ...
                while (accumulator >= fixedDt) {
                    ...
                    publishSnapshot(baseBody, dropBody);
                    accumulator -= fixedDt;
                }
