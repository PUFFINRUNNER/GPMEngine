...
std::cout << "model parts: " << m_model.parts.size() << std::endl;
    ...
    private:
        ...
        void respawnDropCube(P::RigidBody* dropBody) {
            ...
            dropBody->position = M::Point3D(0.0f, 3.0f, -4.0f);
            dropBody->rotation = M::Quaternion::identity();
        ...
        void publishSnapshot(const P::RigidBody* baseBody,
                            const P::RigidBody* dropBody,
                            const P::RigidBody* modelBody) {
            ...
            if (modelBody) {
                ...
                next.model.position = modelBody->position;
                next.model.rotation = modelBody->rotation;
            }
